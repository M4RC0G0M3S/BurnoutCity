...
namespace BurnoutCity.States
{
    public class ShopState : BaseState
    {
        ...
        public override void LoadContent()
        {
            ...
            try { _iconsTexture = ContentManager.Load<Texture2D>("Sprites/Icons/ico"); } 
            catch { _iconsTexture = null; }
        }
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_fontMedium, $"SALDO: {pd.Money} EUR", new Vector2(viewW/2 - 100, 120), Color.LimeGreen);
